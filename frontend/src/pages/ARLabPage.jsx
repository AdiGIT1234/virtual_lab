...
const PART_CATEGORIES = [
  { label: "Basic", parts: [
    ...
    { id: "led-blue",    label: "LED (Blue)",        type: "LED_BLUE" },
  ...
  { label: "Active", parts: [
    ...
    { id: "nmos",        label: "N-MOSFET",          type: "NMOSFET" },
    { id: "pmos",        label: "P-MOSFET",          type: "PMOSFET" },
    { id: "optocoupler", label: "Optocoupler",       type: "OPTOCOUPLER" },
    { id: "timer555",    label: "555 Timer",         type: "TIMER_555" },
    { id: "shiftreg",    label: "Shift Register",    type: "SHIFT_REGISTER" },
  ]},
  { label: "Logic ICs", parts: [
    { id: "logic-and",   label: "AND Gate",          type: "LOGIC_AND" },
    { id: "logic-or",    label: "OR Gate",           type: "LOGIC_OR" },
    { id: "logic-not",   label: "NOT Gate",          type: "LOGIC_NOT" },
    { id: "logic-nand",  label: "NAND Gate",         type: "LOGIC_NAND" },
    { id: "logic-nor",   label: "NOR Gate",          type: "LOGIC_NOR" },
    { id: "logic-xor",   label: "XOR Gate",          type: "LOGIC_XOR" },
    { id: "logic-dff",   label: "D Flip-Flop",       type: "LOGIC_DFLIPFLOP" },
  ]},
  { label: "Output", parts: [
    { id: "servo",       label: "Servo Motor",       type: "SERVO" },
    { id: "sevenseg",    label: "7-Segment",         type: "SEVEN_SEG" },
    { id: "ledmatrix",   label: "LED Matrix 8×8",    type: "LED_MATRIX" },
    { id: "ledbargraph", label: "LED Bar Graph",     type: "LED_BAR_GRAPH" },
    { id: "neopixelring",label: "NeoPixel Ring",     type: "NEOPIXEL_RING" },
    { id: "neopixelpx",  label: "NeoPixel Pixel",    type: "NEOPIXEL_PIXEL" },
  ]},
  { label: "Displays", parts: [
    { id: "oled",        label: "OLED Display",      type: "OLED_SSD1306" },
    { id: "tft",         label: "TFT Display",       type: "ILI9341_TFT" },
    { id: "lcd1602",     label: "LCD 16×2",          type: "LCD1602" },
    { id: "epaper",      label: "E-Paper Display",   type: "EPAPER_BASIC" },
  ]},
  { label: "Sensors", parts: [
    { id: "dht22",       label: "DHT22 Temp/Hum",    type: "DHT22" },
    { id: "pir",         label: "PIR Motion",         type: "PIR_SENSOR" },
    { id: "hcsr04",      label: "HC-SR04 Ultrasonic", type: "HC_SR04" },
    { id: "mpu6050",     label: "MPU6050 IMU",        type: "MPU6050" },
    { id: "photores",    label: "Photoresistor",      type: "PHOTORESISTOR" },
    { id: "ntctemp",     label: "NTC Thermistor",     type: "NTC_SENSOR" },
    { id: "flame",       label: "Flame Sensor",       type: "FLAME_SENSOR" },
    { id: "gas",         label: "Gas Sensor",         type: "GAS_SENSOR" },
    { id: "sound",       label: "Sound Sensor",       type: "SOUND_SENSOR" },
    { id: "rain",        label: "Rain Sensor",        type: "RAIN_SENSOR" },
    { id: "heartbeat",   label: "Heartbeat Sensor",   type: "HEARTBEAT_SENSOR" },
    { id: "hx711",       label: "HX711 Load Cell",    type: "HX711_MODULE" },
    { id: "ttp223",      label: "Touch Sensor",       type: "TTP223_TOUCH" },
    { id: "sw420",       label: "Vibration Sensor",   type: "SW420_VIBRATION" },
    { id: "max30102",    label: "Pulse Oximeter",     type: "MAX30102_PULSE" },
    { id: "tcs34725",    label: "Color Sensor",       type: "TCS34725_COLOR" },
  ]},
  { label: "Input", parts: [
    { id: "encoder",     label: "Rotary Encoder",     type: "ROTARY_ENCODER" },
    { id: "joystick",    label: "Analog Joystick",    type: "ANALOG_JOYSTICK" },
    { id: "dipswitch",   label: "DIP Switch 8",       type: "DIP_SWITCH_8" },
    { id: "slideswitch", label: "Slide Switch",       type: "SLIDE_SWITCH" },
    { id: "keypad",      label: "4×4 Keypad",         type: "MEMBRANE_KEYPAD" },
    { id: "irrx",        label: "IR Receiver",        type: "IR_RECEIVER" },
    { id: "irtx",        label: "IR Remote",          type: "IR_REMOTE" },
  ]},
  { label: "Motors", parts: [
    { id: "dcmotor",     label: "DC Motor",           type: "DC_MOTOR" },
    { id: "l298n",       label: "L298N Driver",       type: "L298N_DRIVER" },
    { id: "stepper",     label: "Stepper Motor",      type: "STEPPER_MOTOR" },
    { id: "relay",       label: "Relay Module",       type: "RELAY_MODULE" },
  ]},
  { label: "Comms", parts: [
    { id: "hc05",        label: "HC-05 Bluetooth",    type: "HC05_BLUETOOTH" },
    { id: "rc522",       label: "RC522 RFID",         type: "RC522_RFID" },
    { id: "rtc",         label: "DS1307 RTC",         type: "DS1307_RTC" },
    { id: "sdcard",      label: "MicroSD Module",     type: "MICROSD_MODULE" },
  ]},
  { label: "Power", parts: [
    { id: "battery",     label: "AA Battery",         type: "AA_BATTERY" },
    { id: "psu",         label: "Bench PSU",          type: "BENCH_PSU" },
    { id: "buck",        label: "Buck Converter",     type: "BUCK_CONVERTER" },
    { id: "lm7805",      label: "LM7805 Regulator",  type: "LM7805_REG" },
    { id: "funcgen",     label: "Function Generator", type: "FUNCTION_GENERATOR" },
    { id: "usb",         label: "USB Connector",      type: "USB_CONNECTOR" },
    { id: "barrel",      label: "Barrel Jack",        type: "BARREL_JACK" },
    { id: "screw2",      label: "Screw Terminal 2",   type: "SCREW_TERMINAL_2" },
    { id: "screw3",      label: "Screw Terminal 3",   type: "SCREW_TERMINAL_3" },
  ]},
];
