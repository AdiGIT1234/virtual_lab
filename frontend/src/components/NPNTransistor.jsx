...
const NPNTransistor = () => {
  ...
  const pins = [
    { id: 'e', label: 'E', cx: 15, desc: 'Emitter',   color: '#f59e0b' },
  ...
  return (
    <div style={{ position: 'relative', display: 'inline-block', userSelect: 'none' }}>
      <svg width={60} height={80} viewBox="0 0 60 80" style={{ overflow: 'visible', display: 'block' }}>
        ...
        {/* Curved top (semicylinder) */}
        <path
          d="M 8 38 A 22 24 0 0 1 52 38 Z"
          fill="#1f2937" stroke="#475569" strokeWidth={1.5}
        />
        {/* Flat body rectangle */}
        <rect x={8} y={22} width={44} height={16} fill="#1f2937" stroke="#475569" strokeWidth={1.5} />
        {/* Inner shading — top highlight */}
        <rect x={9} y={23} width={42} height={4} rx={1} fill="rgba(255,255,255,0.05)" />
        {/* Flat face edge line */}
        <line x1={8} y1={22} x2={52} y2={22} stroke="#64748b" strokeWidth={1} />

        {/* Part number */}
        <text x={30} y={33} textAnchor="middle" fill="#0ea5e9"
          fontSize={8} fontWeight="800" fontFamily="monospace">NPN</text>
